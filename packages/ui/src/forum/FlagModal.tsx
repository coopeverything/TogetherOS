    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
          {/* Reason */}
          <div>
            <label htmlFor="reason" className="block text-base font-medium text-gray-900 dark:text-white dark:text-gray-100 mb-2">
          ...
          {/* Details */}
          <div>
            <label htmlFor="details" className="block text-base font-medium text-gray-900 dark:text-white dark:text-gray-100 mb-2">
          ...
          <div className="flex items-center justify-end gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <button
              ...
              className="px-4 py-2 text-base font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:text-white dark:hover:text-gray-100 transition-colors"
              disabled={isSubmitting}
            >
              Cancel
            </button>
