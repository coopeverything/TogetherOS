    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="text-base text-gray-500 dark:text-gray-400 uppercase tracking-wide">
            Total Initiatives
          </div>
              ...
              >
                ...
                {pattern.preventiveMeasures.length > 0 && (
                  <div className="mt-2">
                    ...
                    <ul className="text-base text-gray-600 dark:text-gray-400 mt-1 list-disc list-inside">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <p className="text-base text-gray-500 dark:text-gray-500 mt-4 text-center">
