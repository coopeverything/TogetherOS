    ...
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center">
          <div className="text-sm font-bold text-orange-600">{stats.length}</div>
          <div className="text-sm text-gray-600 mt-1">Active Topics</div>
        </div>
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 text-center">
          <div className="text-sm font-bold text-orange-600">{totalUsers}</div>
      ...
      {stats.length === 0 ? (
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <h2 className="text-sm font-bold text-gray-900 dark:text-white mb-4">Community Priorities</h2>
          <div className="space-y-2">
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
        <h2 className="text-sm font-bold text-gray-900 dark:text-white mb-4">Trending This Week</h2>
