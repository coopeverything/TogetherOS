    ...
    return (
      <div className="flex items-center justify-center h-48 bg-gray-50 dark:bg-gray-900 rounded-lg">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-base">Loading your interests...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-4">
        <p className="text-red-800 text-base">Error loading interests: {error}</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Your Interest Profile</h3>
      ...
      {/* Top interests */}
      <div>
        <h4 className="text-base font-semibold text-gray-700 mb-3">Top Interests</h4>
            ...
            >
              <div className="flex-grow">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className={`text-base ${getTrendColor(interest.trend)}`}>
      ...
      {risingInterests.length > 0 && (
        <div>
          <h4 className="text-base font-semibold text-gray-700 mb-3">Rising Interests 📈</h4>
      ...
      {/* All interests list */}
      <div>
        <h4 className="text-base font-semibold text-gray-700 mb-3">All Topics ({interests.length})</h4>
        <div className="max-h-64 overflow-y-auto bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
          <div className="space-y-1">
            {interests.map((interest) => (
              <div
                key={interest.topic}
                className="flex items-center justify-between text-base py-1.5 px-3 hover:bg-white dark:bg-gray-800 rounded"
              >
