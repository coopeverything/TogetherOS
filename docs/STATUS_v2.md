...
| **Search & Tags** | Global search with filters, proposal search (Phase 1), path/keyword facets, privacy-preserving query tracking, relevance scoring | <!-- progress:search=50 --> 50% | Expand to forum/profiles (Phase 2) | Phase 1 complete: spec + DB + API + UI |
