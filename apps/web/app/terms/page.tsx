...
export default function TermsPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-4xl font-bold text-ink-900 mb-8">Terms of Service</h1>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Introduction</h2>
      ...
      {Acceptance of Terms */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Acceptance of Terms</h2>
        <p className="text-ink-700 mb-4">
          By creating an account, posting content, or otherwise using TogetherOS, you agree to:
        </p>
        <ul className="list-disc pl-6 mb-4 text-ink-700">
      ...
      {User Accounts */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">User Accounts</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">User Content and Ownership</h2>
        <h3 className="text-xl font-semibold text-ink-900 mb-3">Your Content</h3>
        <p className="text-ink-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-ink-900 mb-3 mt-6">Social Media Imports</h3>
        <p className="text-ink-700 mb-4">
      ...
      {Acceptable Use */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Acceptable Use</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Community Guidelines</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Intellectual Property</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Third-Party Services</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Disclaimer of Warranties</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Limitation of Liability</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Indemnification */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Indemnification</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Dispute Resolution */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Dispute Resolution</h2>
        <p className="text-ink-700 mb-4">
          If you have a dispute with TogetherOS:
        </p>
        <ol className="list-decimal pl-6 mb-4 text-ink-700">
          <li className="mb-2">
      ...
      {Termination */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Termination</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Changes to Terms */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Changes to These Terms</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Governing Law */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Governing Law</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Severability */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Severability</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Entire Agreement */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Entire Agreement</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Contact Us */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Contact Us</h2>
        <p className="text-ink-700 mb-4">
          If you have questions about these Terms, please contact us:
        </p>
        <ul className="list-none pl-0 mb-4 text-ink-700">
          <li className="mb-2">
            <strong>Email:</strong>{' '}
            <a
              href="mailto:privacy@coopeverything.org"
