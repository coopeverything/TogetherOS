...
export default function PrivacyPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-4xl font-bold text-ink-900 mb-8">Privacy Policy</h1>
      ...
      {Data We Collect */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Data We Collect</h2>

        <h3 className="text-xl font-semibold text-ink-900 mb-3">1. User-Created Posts</h3>
        <p className="text-ink-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-ink-900 mb-3">2. Social Media Imports</h3>
        <p className="text-ink-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-ink-900 mb-3">3. Technical Data</h3>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">How We Use Your Data</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Third-Party Data Sharing</h2>
        <p className="text-ink-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-ink-900 mb-3 mt-6">Instagram-Specific Disclosures</h3>
        <p className="text-ink-700 mb-4">
      ...
      {Your Rights */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Your Rights</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8 bg-orange-50 border-l-4 border-orange-500 p-6">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Data Deletion</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Data Security */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Data Security</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Data Retention */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Data Retention</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Cookies and Tracking</h2>
        <p className="text-ink-700 mb-4">
      ...
      {Children's Privacy */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Children&apos;s Privacy</h2>
        <p className="text-ink-700 mb-4">
      ...
      {International Users */}
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">International Users</h2>
        <p className="text-ink-700 mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-ink-900 mb-4">Changes to This Policy</h2>
        <p className="text-ink-700 mb-4">
