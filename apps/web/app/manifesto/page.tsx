      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg prose-orange max-w-none">
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">The Problem</h2>
          ...
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">The Opening</h2>
            <p className="text-ink-700 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">The Obstacle</h2>
            <p className="text-ink-700 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">The Answer: An Operating System for Cooperation</h2>
            ...
            <h3 className="text-2xl font-semibold text-ink-900 mb-3">Core mechanics</h3>
          ...
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">How TogetherOS Changes Behavior</h2>
            <ul className="space-y-3 text-ink-700">
              <li>
          ...
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">Gamification & Immersive Experience</h2>
            <p className="text-ink-700 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">Eight Paths of Cooperation for Resilience and Prosperity</h2>
          ...
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">From Scarcity to Prosperity — Practical Intent</h2>
            <p className="text-ink-700 leading-relaxed">
            ...
            <p className="text-ink-700 italic mt-4">
          ...
          <section className="mb-10">
            <h2 className="text-3xl font-bold text-ink-900 mb-4">Culture & Promise</h2>
            <p className="text-ink-700 leading-relaxed">
          ...
          <section className="mt-12 p-6 bg-orange-50 border-l-4 border-orange-500 rounded-r-lg">
            <h2 className="text-2xl font-bold text-ink-900 mb-3">Help Build TogetherOS</h2>
