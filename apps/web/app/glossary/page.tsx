      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-500">Quick definitions, deeper links</p>
            </div>
          </div>
          ...
          <div className="mt-6">
            <Link
              href="/wiki"
              className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-gray-700 hover:border-emerald-300 hover:bg-emerald-50 transition-colors"
            >
              <svg
                className="w-4 h-4"
                fill="none"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-10">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 text-center">
            ...
            <div className="text-sm text-gray-500">Letters Used</div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-4 text-center md:col-span-1 col-span-2">
            <div className="text-2xl font-bold text-blue-600">
              {glossaryTerms.filter((t) => t.wikiArticleSlug).length}
            </div>
            <div className="text-sm text-gray-500">With Wiki Articles</div>
          </div>
        </div>

        {/* Alphabet Navigation */}
        <div className="bg-white rounded-xl border border-gray-200 p-4 mb-8 sticky top-4 z-10">
                ...
                {groupedTerms[letter].map((term) => {
                  ...
                  return (
                    <Link
                      ...
                      className="block bg-white rounded-xl border border-gray-200 p-5 hover:border-emerald-300 hover:shadow-sm transition-all group"
                    >
