        ...
        <div className="flex items-center gap-4">
          {counts.unread > 0 && (
            <button
              ...
              className="text-base text-orange-600 hover:text-orange-700 font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded"
            >
              Mark all as read
            </button>
          )}
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg text-base font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
          >
      ...
      <div className="flex gap-2 mb-6 flex-wrap border-b border-gray-200 dark:border-gray-700 pb-4">
        {filters.map((filter) => (
          <button
            ...
            className={`px-4 py-2 rounded-lg text-base font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2 ${
          ...
          >
            ...
            {filter.key === 'unread' && counts.unread > 0 && (
              <span className="ml-2 px-3 py-0.5 bg-white dark:bg-gray-800/20 text-sm rounded-full">
                {counts.unread}
              </span>
            )}
          </button>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-base text-gray-600 dark:text-gray-400 mb-2 line-clamp-2">{notif.message}</p>
                ...
                {notif.priority === 'high' && (
                  <span className="px-3 py-1.5 bg-red-100 text-red-800 text-sm font-medium rounded">
                    Important
                  </span>
                )}
              </div>
