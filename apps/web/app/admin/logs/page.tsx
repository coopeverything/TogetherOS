          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Uptime</p>
                  <p className="text-2xl font-mono">
                    {formatUptime(metrics.process.uptime_seconds)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Heap Used</p>
                  <p className="text-2xl font-mono">
                    {formatBytes(metrics.process.memory.heap_used)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Heap Total</p>
                  <p className="text-2xl font-mono">
                    {formatBytes(metrics.process.memory.heap_total)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">RSS</p>
                  <p className="text-2xl font-mono">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Used</p>
                  <p className="text-lg font-mono">
                    {formatBytes(metrics.system.memory.used)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Free</p>
                  <p className="text-lg font-mono">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">1 min</p>
                  <p className="text-2xl font-mono">
                    {metrics.system.load_average['1min'].toFixed(2)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">5 min</p>
                  <p className="text-2xl font-mono">
                    {metrics.system.load_average['5min'].toFixed(2)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">15 min</p>
                  <p className="text-2xl font-mono">
                    {metrics.system.load_average['15min'].toFixed(2)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">Normalized</p>
                  <p
            ...
            {/* Raw JSON */}
            <details className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <summary className="text-xl font-semibold cursor-pointer">
                Raw JSON Response
              </summary>
              <pre className="mt-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-md overflow-x-auto text-sm">
