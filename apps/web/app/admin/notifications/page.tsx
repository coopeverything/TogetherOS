  ...
  useEffect(() => {
    fetch('/api/auth/me')
      ...
      .then(data => {
        ...
        else router.push('/login?redirect=/admin/notifications')
      })
      .catch(() => router.push('/login?redirect=/admin/notifications'))
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-0)', padding: '2rem 1rem' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginTop: '0.5rem' }}>Email & Notifications</h1>
        </div>
