              ...
              <div className="space-y-3">
                {typographyScale.map(item => (
                  <div key={item.name} className="flex items-baseline gap-4">
                    <code className="text-xs bg-bg-2 px-2 py-0.5 rounded w-16 text-center text-ink-700">
                      {item.name}
                    </code>
                    <span className="text-ink-700 text-sm w-32">
                      {item.size}
                    </span>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-bg-1 rounded-lg border border-border p-4">
              ...
              <div className="flex flex-wrap gap-3">
                <button className="px-4 py-2 bg-brand-600 text-bg-1 rounded-lg hover:opacity-90 transition-colors text-sm font-medium">
                  Primary
                </button>
                <button className="px-4 py-2 bg-bg-2 text-ink-900 rounded-lg hover:opacity-80 transition-colors text-sm font-medium">
                  Secondary
                </button>
                <button className="px-4 py-2 border border-border text-ink-700 rounded-lg hover:bg-bg-2 transition-colors text-sm font-medium">
                  Outline
                </button>
                <button className="px-4 py-2 text-brand-600 hover:opacity-80 transition-colors text-sm font-medium">
                  Ghost
                </button>
                <button className="px-4 py-2 bg-joy-600 text-bg-1 rounded-lg hover:opacity-90 transition-colors text-sm font-medium">
                  Joy Accent
                </button>
              </div>
            </div>
            ...
            <div className="bg-bg-1 rounded-lg border border-border p-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-0.5 bg-bg-2 text-ink-700 rounded text-xs font-medium">
                  Default
                </span>
                <span className="px-2 py-0.5 bg-brand-100 text-brand-600 rounded text-xs font-medium">
                  Brand
                </span>
                <span className="px-2 py-0.5 bg-joy-100 text-joy-600 rounded text-xs font-medium">
                  Joy
                </span>
