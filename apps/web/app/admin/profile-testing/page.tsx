...
function SimpleProfileCard({ user }: { user: User }) {
  ...
  return (
    <Card className="p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {user.username && user.name && (
            <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">@{user.username}</p>
          )}
      ...
      {user.bio && (
        <p className="mt-4 text-gray-700 dark:text-gray-300 text-sm">{user.bio}</p>
      )}

      {userPaths.length > 0 && (
        <div className="mt-4">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">Cooperation Paths</h4>
      ...
      {user.skills && user.skills.length > 0 && (
        <div className="mt-4">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-2">Skills</h4>
          <div className="flex flex-wrap gap-2">
      ...
      {user.can_offer && (
        <div className="mt-4">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Can Offer</h4>
          <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">{user.can_offer}</p>
        </div>
      )}

      {user.seeking_help && (
        <div className="mt-4">
          <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Seeking Help</h4>
          <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">{user.seeking_help}</p>
        </div>
      )}
    </Card>
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Profile Components Test Page</h1>
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Complete Profile</h3>
                    <SimpleProfileCard user={SAMPLE_PROFILES.complete} />
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Partial Profile</h3>
                    <SimpleProfileCard user={SAMPLE_PROFILES.partial} />
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Minimal Profile</h3>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Minimal (Getting Started)</h3>
                    <ProfileCompletionIndicator user={SAMPLE_PROFILES.minimal} />
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Partial (Almost There)</h3>
                    <ProfileCompletionIndicator user={SAMPLE_PROFILES.partial} />
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Complete</h3>
                    <ProfileCompletionIndicator user={SAMPLE_PROFILES.complete} />
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">With showDetails=false</h3>
                    <ProfileCompletionIndicator user={SAMPLE_PROFILES.complete} showDetails={false} />
                    <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-2">(Hidden when complete and showDetails=false)</p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="max-w-2xl">
                  <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Interactive Skills Input</h3>
                  <TagInput
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">What I Can Offer</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">What I&apos;m Seeking</label>
                    <textarea
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500">
                    Try: <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">alexrivera</code> or any other username
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <textarea
                    id="put-data"
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md font-mono text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    rows={10}
