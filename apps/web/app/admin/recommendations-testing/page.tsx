  ...
  return (
    <div className="min-h-screen bg-bg-1 p-4">
      <div className="max-w-6xl mx-auto">
        <div className="mb-4">
          <h1 className="text-sm font-bold mb-2">Bridge Recommendations Test</h1>
        ...
        {/* Controls */}
        <div className="bg-bg-0 rounded-lg shadow p-4 mb-3">
        ...
        {recommendations.length > 0 && (
          <div className="space-y-2">
            ...
            {recommendations.map((rec) => (
              <div key={rec.id} className="bg-bg-0 rounded-lg shadow p-4">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    ...
                    <h3 className="text-sm font-semibold mb-2">{rec.title}</h3>
        ...
        {recommendations.length === 0 && !loading && (
          <div className="bg-bg-0 rounded-lg shadow p-4 text-center text-ink-400">
