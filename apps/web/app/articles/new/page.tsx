      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link
              href="/signup"
              className="px-5 py-2.5 bg-bg-1 border border-border text-ink-700 rounded-lg hover:bg-bg-0 transition-colors font-medium"
            >
              Sign Up
            </Link>
          </div>
          ...
          <div className="bg-bg-1 rounded-xl border border-border p-4">
            ...
            <div className="prose prose-lg max-w-none">
              {content ? (
                ...
                <p className="text-ink-400 italic">Your content here...</p>
              )}
            </div>
            {tags.length > 0 && (
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className={`flex-1 px-4 py-2 rounded-lg border bg-bg-1 text-ink-900 placeholder:text-ink-400 focus:ring-2 focus:ring-orange-500 focus:border-transparent ${
                ...
                <button
                  ...
                  className="px-4 py-2 bg-bg-2 text-ink-700 rounded-lg hover:bg-bg-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Add
                </button>
              </div>
            ...
            <div className="flex items-center justify-between pt-6 border-t border-border">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  disabled={isSubmitting}
                  className="px-5 py-2.5 bg-bg-2 text-ink-700 rounded-lg hover:bg-bg-2 font-medium disabled:opacity-50"
                >
