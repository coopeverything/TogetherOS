...
export const sampleNotifications: Notification[] = [
  {
    ...
    message: 'A proposal requiring your input has been submitted',
    icon: '📋',
    priority: 'high',
    status: 'unread',
    reference: {
  ...
  },
  {
    ...
    message: 'Someone replied to "Privacy vs transparency trade-offs"',
    icon: '💬',
    priority: 'normal',
    status: 'unread',
    reference: {
  ...
  },
  {
    ...
    message: 'New members joined and posted introduction',
    icon: '👥',
    priority: 'normal',
    status: 'read',
    reference: {
  ...
  },
  {
    ...
    message: 'You have 87 points available to allocate this month',
    icon: '⭐',
    priority: 'normal',
    status: 'read',
    reference: {
  ...
  },
  {
    ...
    message: 'You earned the Early Contributor badge for your first merged PR!',
    icon: '🏆',
    priority: 'high',
    status: 'read',
    reference: {
  ...
  },
  {
    ...
    message: '@you mentioned you in a discussion about cooperative housing',
    icon: '💬',
    priority: 'normal',
    status: 'archived',
    reference: {
